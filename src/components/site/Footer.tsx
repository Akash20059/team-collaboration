      ...
      <div className="container-page grid md:grid-cols-3 gap-10">
        <div>
          <div className="flex items-center gap-3">
            <div className="h-14 w-14 rounded-full overflow-hidden shrink-0 border-[3px] border-[#D4540A]">
              <img src={logo} alt="Logo" className="h-full w-full object-cover scale-105" width={56} height={56} />
            </div>
            <div>
